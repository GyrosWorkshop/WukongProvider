...
class Controller {
     ...
     * @apiParam {string} [withCookie]
     * @apiParam {string} [sendPlayLog=true] If valid cookie is provided and withFileUrl is set, play log will be sended to netease-cloud-music to track your play count. **not sure this will work
     * @apiSuccessExample Success-Response:
     *      HTTP/1.1 200 OK
     *      {
     *      }
